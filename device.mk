...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/perfo/msm_irqbalance.conf:$(TARGET_COPY_OUT_VENDOR)/etc/msm_irqbalance.conf \
    $(LOCAL_PATH)/configs/perfo/powerhint.json:$(TARGET_COPY_OUT_VENDOR)/etc/powerhint.json \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/telephony_system-ext_privapp-permissions-qti.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sysconfig/telephony_system-ext_privapp-permissions-qti.xml
